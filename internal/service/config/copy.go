...
func CopyConfigWithHelp(sourcePath, destPath string, encryptEnabled bool, encryptionReceiver string) error {
	...
	helpComments += "# ------------------------\n"
	helpComments += "# IMPORTANT: THIS IS AN AUTO-GENERATED FILE - DO NOT MODIFY MANUALLY\n"
	helpComments += "# This file was automatically generated by go-backup and is a copy of the original config.\n"
	helpComments += "# It contains configuration settings for restoring this backup.\n"
	helpComments += "# The original config file should be preserved separately.\n"
	helpComments += "#\n"
	...
	helpComments += "#\n"
	helpComments += "# Generated on: " + fmt.Sprintf("%s\n", time.Now().Format("2006-01-02 15:04:05"))
	helpComments += "#\n"
